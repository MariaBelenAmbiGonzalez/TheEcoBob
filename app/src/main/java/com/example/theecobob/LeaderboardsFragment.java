...
import com.example.theecobob.databinding.FragmentLeaderboardsBinding;
...
public class LeaderboardsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.recyclreView.setAdapter(adapter);
        binding.recyclreView.setLayoutManager(new LinearLayoutManager(getContext()));
